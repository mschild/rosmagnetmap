...
cd "/localhome/demo/catkin_ws/src/rosserial/rosserial_xbee"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/localhome/demo/catkin_ws/src/rosserial/rosserial_xbee/setup.py" \
    build --build-base "/localhome/demo/catkin_ws/build/rosserial/rosserial_xbee" \
    install \
    $DESTDIR_ARG \
